...
echo       Copying files...
robocopy "C:\Temp\370zMonitor\Arduino" "G:\My Drive\Arduino\repos\!CAN\370zMonitor" /MIR /XD .git build /XF *.elf *.bin *.o /R:3 /W:5
if %ERRORLEVEL% LEQ 3 (
...
echo       Copying files...
robocopy "C:\Temp\370zMonitor\SquareLine" "G:\My Drive\Arduino\repos\SquareLine Studio\!370z Monitor" /MIR /XD .git /XF *.tmp /R:3 /W:5
if %ERRORLEVEL% LEQ 3 (
